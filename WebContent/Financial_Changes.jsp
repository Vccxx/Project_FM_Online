...
<head>
    ...
    <style type="text/css">
	body{
		background-image:url(image/fcbg.jpg);
		background-size:100% 100%;
		}
	</style>
<title>Financial Change Log Panel</title>
</head>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			<p>
				<font size="10">你好,<%=request.getParameter("username")%><font size="6">——请进行财务变更记录审查</font></font>
			</p>
		</div>
	</div>
</div>
                ...
                <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                      <% 
						...
						con = DriverManager.getConnection("jdbc:mysql://localhost:3306/FManager","root","Vccxx2016");
						Statement sql;
						ResultSet rs;
						int line=0;
